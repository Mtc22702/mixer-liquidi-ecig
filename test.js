...
const { calculateRecipe, recommendBases, updateBaseVolume, updateFixedVolume } = require('./mixer.js');
const ingredients = [
...
console.log(recommendBases({ finalVolume: 60, targetVg: 50, aromaVolume: 3.5, nicotineVolume: 25, nicotineRatio: {pg:30,vg:70} }));
